...
public class Game {
    ...
    public void insertQuestionFromFile() {
        InputStream inputStream = getClass().getResourceAsStream("/game/pirate/gui/Assets/DataQuestions.txt");
        try {
    ...
    public void insertPosIslandFromFile() {
        InputStream inputStream = getClass().getResourceAsStream("/game/pirate/gui/Assets/Position.txt");
        try {
            BufferedReader reader = new BufferedReader(new InputStreamReader(inputStream));
            String line;
            while ((line = reader.readLine()) != null) {
